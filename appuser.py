# appuser.py (Final Grounded Version)
...
# --- CONFIGURATION ---
# I've updated the title to be more specific for your school
...
# This should be your sandbox folder ID.
...
# Create the Question-Answering chain with the new, strict prompt
qa_chain = RetrievalQA.from_chain_type(
    llm=ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0, openai_api_key=OPENAI_API_KEY),
    chain_type="stuff",
    retriever=vector_store.as_retriever(),
    return_source_documents=True,
    chain_type_kwargs={"prompt": STRICT_PROMPT} # <-- THIS IS THE KEY CHANGE
)
